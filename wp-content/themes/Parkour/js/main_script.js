var time_arrow_scroll = 500,
    time_tranciscion_slide = 1500,
    special_easing_tranciscion = "easeOutBack",
    function_finish_tranciscion = function(){};
...
$(function(){
    ...
    $('a.scroll_to').click(function(){
        ...
        },{duration:time_tranciscion_slide,
            specialEasing:{
                scrollLeft: special_easing_tranciscion
            },complete:function(){
                function_finish_tranciscion();
        }})
